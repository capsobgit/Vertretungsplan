...
public class TabellenSubFenster extends JDialog
{
    ...
    public TabellenSubFenster(final Model model, StundenTabelleView parent,
            Point tablePoint, Point mousePoint, IServerTableModel remote)
    {
        ...
        setSize(500, 200);
        setLocation(mousePoint.getEventTableRow(), mousePoint.getEventTableCol() + 110);
